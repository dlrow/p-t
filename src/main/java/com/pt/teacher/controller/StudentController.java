...
/**
 * Purpose:-
 * This is a student controller that routes different incoming requests related to student which is done by teacher.
 *
...
public class StudentController {
    ...
    {
        log.info("Executing StudentController.addStudent() with param studentDetailsDTO:{}"+
                " Routing the incoming request to studentService to add the student to our System.",studentDetailsDTO);
        ...
        log.info("Returning the Response Message which consist of studentId for Saved student and Success code from StudentController.addStudent()");
    ...
    public ResponseEntity<StudentDetailsDTO> getStudent(@PathVariable("studentid") String studentId) {
        ...
        log.info("Returning the studentDetailsDTO which consist student details of Saved student from StudentController.getStudent()");
    ...
    {
        log.info("Executing StudentController.updateStudent() with param studentDetailsDTO:{}" +
                "Routing the incoming request to studentService to update the student details.", studentDetailsDTO);
        ...
        log.info("Returning the Response Message which consist of Success Msg and Success code  after Successful" +
                " updation in student details" +
                        "from StudentController.updateStudent()");
    ...
    public ResponseEntity<ResponseMessage> deleteStudent(@PathVariable("studentid") String studentId)
    {
        log.info("Executing StudentController.deleteStudent() with param studentId:{}"+
                "  Routing the incoming request to studentService to delete the student details from our System.",studentId);
        ...
        log.info("Returning the Response Message which consist of Success Msg and Success code  after Successful" +
                ...
                "from StudentController.deleteStudent()");
        return ResponseEntity.ok().body(responseMessage);
    }
    ...
    {
        log.info("Executing StudentController.getAllStudent() with param classId:{}"+
                "  Routing the incoming request to studentService to get all the student from our System.",classId);
